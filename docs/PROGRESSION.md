...
| `aeronautics:wooden_propeller` | shaft ringed by 4 slabs — cheap EARLY thrust, carries a flight-calibrated drag penalty (~15% of its own thrust; wooden ships fly slower) |
